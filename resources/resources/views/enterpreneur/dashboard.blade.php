            ...
            <div class="w-full md:w-3/12 md:mx-2 shadow-lg rounded-lg">
                ...
                <div class="bg-white p-5 border-t-4 border-red-500">
                    ...
                    <p class="text-sm text-gray-500 hover:text-gray-500 leading-4">
                        ...
                        <a href="{{ route('titlecover.create') }}"><button class="py-3 px-3 my-4 transition-colors duration-700 transform bg-gray-500 hover:bg-blue-400 text-gray-100 rounded-lg focus:border-4 border-indigo-300 text-sm">Professional Summary</button></a>
