...
<div id="modal" class="pacity-0 transform -translate-y-full scale-150  relative w-10/12 md:w-1/2 h-1/2 md:h-3/4 bg-white rounded shadow-lg duration-300">
    ...
    <form  method="POST" action="{{ route('workexperience.store') }}">
        @csrf
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <x-input id="employment_type" class="block mt-1 w-full" type="text" name="employment_type" :value="old('employment_type')" required autofocus/>
                </div>
                ...
                <x-label for="start_date" :value="__('Start Date:')" />
                    <x-input id="start_date" class="block mt-1 w-full" type="text" name="start_date" :value="old('start_date')" required autofocus />
                </div>

                <div>
                <x-label for="end_date" :value="__('End Date:')" />
                    <x-input id="end_date" class="block mt-1 w-full" type="text" name="end_date" :value="old('end_date')" required autofocus />
                </div>

                <div>
                <x-label for="industry" :value="__('Industry:')" />
                    <x-input id="industry" class="block mt-1 w-full" type="text" name="industry" :value="old('industry')" required autofocus />
                </div>
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1 pb-4">
                <div>
                    ...
                    <textarea id="description" cols="5" rows="2"  class="block mt-1 w-full" name="description" :value="old('description')"></textarea>
                </div>
            </div>

            <div class="flex justify-between mt-6">
               
               <button name="save_add" class="px-6 py-2 leading-5 text-black transition-colors duration-200 transform bg-white rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Save</button>
           </div>
