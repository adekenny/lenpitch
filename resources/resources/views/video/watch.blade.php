...
<div id="modal" class="pacity-0 transform -translate-y-full scale-150  relative w-10/12 md:w-1/2 h-1/2 md:h-3/4 bg-white rounded shadow-lg transition-opacity transition-transform duration-300">
    ...
    <!-- button close -->
    <button id="closeVideo" style="display:none"
    ...
    <div class="px-4 py-3 border-b border-gray-200 h-auto">
        <p class="text-2xl">Please watch this 60 secs video before uploading yours</p>  
    </div>
    
    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1 pb-4" id="video">
...
setTimeout(myFunction, 10000), false);

function myFunction() {
 
  window.location = "http://127.0.0.1:8000/video/create";
}
