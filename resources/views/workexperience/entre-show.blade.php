...
<div id="modal_overlay" class="absolute inset-0 bg-black bg-opacity-80 h-screen w-full flex justify-center items-start md:items-center pt-10 md:pt-0">
    ...
    <!-- modal -->
<div id="modal" class="opacity-0 transform -translate-y-full scale-150  relative w-10/12 md:w-2/3 md:h-auto bg-white rounded shadow-lg transition-opacity transition-transform duration-300 p-6">
    ...
    <!-- header -->
        <div class="gap-8 p-6 flex-col">
            <div class="text-lg my-6" style="font-size:.98em"><b>Business Relationship Title:</b>: {{ $workexperience->title}}</div>
            <div class="text-lg my-6" style="font-size:.98em" ><b>Target Company / End Users:</b>: {{ $workexperience->company_name}}</div>
        
           
            <div class="text-lg my-6" style="font-size:.98em"><b>Location:</b>: {{ $workexperience->location}}</div> 
           
         
            <div class="text-lg my-6" style="font-size:.98em"><b>Industry:</b>: {{ $workexperience->industry}}</div>
            <div class="text-lg col-span-2 my-6" style="font-size:.98em"><b>Detailed Proposed Business Activities:</b>: {{ $workexperience->description}}</div>
