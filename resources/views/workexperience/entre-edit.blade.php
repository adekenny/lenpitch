...
<div>
<x-label for="title" :value="__('Business Relationship Title:')" />
...
<div>
<x-label for="company_name" :value="__('Target Company / End Users:')" />
...
<div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1 pb-4">
<div>
<x-label for="description" :value="__('Detailed Proposed Business Activities:')" />
