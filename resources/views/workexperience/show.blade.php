...
<div id="modal" class="opacity-0 transform -translate-y-full scale-150  relative w-10/12 md:w-3/4 md:h-auto bg-white rounded shadow-lg transition-opacity transition-transform duration-300 p-6">
    ...
    <div class="grid grid-cols-2 gap-8 px-4 py-4">
            <div class="col-span-2 text-lg" style="font-size:.98em"><b>Job Title</b>: {{ $workexperience->title}}</div>
            <div class="text-lg" style="font-size:.98em" ><b>Company Name</b>: {{ $workexperience->company_name}}</div><div class="text-lg" style="font-size:.98em"><b>Employment Type</b>: {{$workexperience->employment_type}}</div>
           
            <div class="text-lg" style="font-size:.98em"><b>Location</b>: {{ $workexperience->location}}</div> <div class="text-lg" style="font-size:.98em"><b>Start Date</b>: {{ $workexperience->start_date}}</div>
            <div class="text-lg" style="font-size:.98em"><b>End Date</b>: {{ $workexperience->end_date}}</div><div class="text-lg" style="font-size:.98em"><b>Industry</b>: {{ $workexperience->industry}}</div>
            <div class="text-lg col-span-2" style="font-size:.98em"><b>Job Description</b>: {{ $workexperience->description}}</div>
