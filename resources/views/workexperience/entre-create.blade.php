...
<div id="modal" class="opacity-0 transform -translate-y-full scale-150  relative w-10/12 md:w-2/3 md:h-auto bg-white rounded shadow-lg transition-opacity transition-transform duration-300">
    ...
    @csrf
        ...
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1">
            ...
            <div>
                ...
                <select name="location" style="border-radius:5px; width:100%; font-size:14px;  border-color:#cccccc;" id="country" required>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
            ...
            <select name="industry" style="border-radius:5px; width:100%; font-size:14px;  border-color:#cccccc;" id="industry" required>
        ...
        <div class="flex justify-between mt-6">
           ...
           <button name="save_add" class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-black rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Save</button>
       </div>
