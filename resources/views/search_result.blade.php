...
@endphp</span>
                            <a class="px-3 py-1 text-sm font-bold text-gray-100 transition-colors duration-200 transform bg-red-600 rounded cursor-pointer hover:bg-gray-500" href="{{ url('enter_profile/'.$user->user_id) }}">View Profile</a>
                        </div>
                        <div class="mt-2">
                            <a href="#" class="text-2xl font-bold text-gray-700 dark:text-white hover:text-gray-600 dark:hover:text-gray-200 hover:underline">@if($user->firstname) {{$user->firstname}} @endif @if($user->surname) {{$user->surname}} @endif - @if($user->title) {{ $user->title }} @endif</a>&nbsp;&nbsp;@if($user->verification == 'verified') <img src="{{ asset('images/verify.png') }}" width="30"
                                height="30" style="float: left;" /> @endif
                            @if($user->description) 
                            <p class="mt-2 text-gray-600 dark:text-gray-300">{{$user->description}}</p>
                            @endif
                        </div>

                        <div class="flex items-center mt-4">
                            @if($user->photo)
                            <img class="hidden object-cover w-18 h-14 mx-4 rounded-full sm:block" src="{{ asset('lenspitch/public/storage/'.$user->photo) }}" alt="avatar">@endif &nbsp;&nbsp; &nbsp;&nbsp;
                    ...
                    <div class="bg-white w-full h-auto col-span-2">
                        ...
                        <video width="700" height="220" controls>
                            ...
                            <source src="{{ asset('lenspitch/public/storage/'.$user->video) }}" type="video/mp4">
                           
          
                        </video>
                        <div class="text-sm"><a href="{{ url('view_large_video/'.$user->user_id) }}"><b>View enlarged video</b></a></div>
                         @else
            ...
            <div class="flex flex-wrap text-white">
                <div class="w-full lg:w-6/12 px-4">
                    ...
                    <div class="mt-6 flex justify-start">
                        <a href="https://www.facebook.com/profile.php?id=100075706996813" target="_blank"><img src="{{ asset('public/images/facebook.png') }}" class="w-10 h-10 mr-2"/></a>
                        <a href="https://twitter.com/LENSPITCHS" target="_blank"><img src="{{ asset('public/images/twittter.png') }}" class="w-10 h-10 mr-2"/></a>
                        <a href="https://www.instagram.com/lenspitchs/" target="_blank"><img src="{{ asset('public/images/instagram.png') }}" class="w-10 h-10"/></a>
                    </div>
