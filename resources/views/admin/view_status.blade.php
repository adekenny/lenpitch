                  ...
                  @php $x = 1; @endphp 
                    ...
                    @foreach($users as $user)
                      ...
                      <td class="p-1 text-sm">
                          ...
                          <span class="text-blue-600 font-bold">{{ $user->status }}</span>
                          @else
                          <span class="text-red-600 font-bold">{{ $user->status }}</span>
                          @endif
                        </td>
                      <td class="p-1 text-sm">
                     {{ $user->verification }}
                      ...
                      <td class="p-1 text-sm"> 
                          @if($user->status === 'enabled')
                             <a href="{{ url('admin/'.$user->id.'/disable_status') }}"><button class="px-4 py-1 hover:bg-blue-400 text-white rounded-full focus:border-4 border-indigo-300 bg-red-600 text-sm leading-3">disable</button>
                          @endif
                          @if($user->status === 'disabled')
                             <a href="{{ url('admin/'.$user->id.'/enable_status') }}"><button class="px-4 py-1 text-white rounded-full focus:border-4 border-indigo-300 bg-blue-500 text-sm leading-3">enable</button>
                          @endif
                    </td>
	                  	</tr>
                      @php $x++; @endphp 
