                    ...
                    <div class="flex-auto p-4">
                      <div class="flex flex-wrap">
                        <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                          ...
                          <span class="font-semibold text-xl text-blueGray-700">
                             {{Auth::user()->where('verification', 'verified')->count()}}
                          </span>
                        </div>
                        <div class="relative w-auto pl-4 flex-initial">
                    ...
                    <div class="flex-auto p-4">
                      <div class="flex flex-wrap">
                        <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                          ...
                          <span class="font-semibold text-xl text-blueGray-700">
                            {{Auth::user()->where('status', 'enabled')->count()}}
                          </span>
                        </div>
                        <div class="relative w-auto pl-4 flex-initial">
            ...
            <div class="w-full xl:w-12/12 px-4">
              ...
              >
                ...
                <div class="p-2 flex-auto">
                    <form  method="POST" action="{{ route('search_email') }}">
        @csrf
        <div class="container mx-auto px-4 md:w-3/4 mb-4 py-2 bg-blue-500 rounded-xl">
            <div class="flex">
                <input type="text" placeholder="search by email address" name="email"/>

    <input type="submit" name="search" value="SEARCH" class="py-2 px-6 bg-black text-white leading-3 text-1xl rounded"  />
</div>
</div>
</form>
                  <!-- Chart -->
                 ...
                 <thead>
                  ...
                  @php $x = 1; @endphp 
                    ...
                    @foreach($users as $user)
                      ...
                      <td class="p-1 text-sm"> <a href="{{ url('admin_view_user/'.$user->id) }}"><button class="px-4 py-1 hover:bg-blue-400 text-white rounded-full focus:border-4 border-indigo-300 bg-black text-sm leading-3">view profile</button></td>
	                  	</tr>
                      @php $x++; @endphp 
