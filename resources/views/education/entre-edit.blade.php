    ...
    <form action="{{ url('education/'.$education->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1 pb-4">
                <div>
                    ...
                    <x-input id="institution" class="block mt-1 w-full" type="text" name="institution"  value="{{ $education->institution }}" required autofocus />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div>
                    ...
                    <x-input id="qualification" class="block mt-1 w-full" type="text" name="qualification" value="{{ $education->qualification }}" required autofocus/>
                </div>

                <div>
                    <x-label for="study_field" :value="__('Field of Study:')" />
                    <x-input id="study_field" class="block mt-1 w-full" type="text" name="study_field" value="{{ $education->study_field }}" required autofocus />
                </div>

                <div>
                    <x-label for="start_date" :value="__('Start Date:')" />
                    <x-input id="start_date" class="block mt-1 w-full" type="text" name="start_date" value="{{ $education->start_date }}" required autofocus />
                </div>

                <div>
                <x-label for="end_date" :value="__('End Date:')" />
                    <x-input id="end_date" class="block mt-1 w-full" type="text" name="end_date" value="{{ $education->end_date }}" required autofocus />
                </div>

                <div>
                <x-label for="grade" :value="__('Grade:')" />
                    <x-input id="grade" class="block mt-1 w-full" type="text" name="grade" value="{{ $education->grade }}" required autofocus />
                </div>
