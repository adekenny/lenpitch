...
<div id="modal" class="opacity-0 transform -translate-y-full scale-150  relative w-10/12 md:w-2/3 md:h-auto bg-white rounded shadow-lg transition-opacity transition-transform duration-300 p-6">
    ...
    <div class="grid grid-cols-2 gap-8 px-4 py-4">
            <div class="text-lg col-span-2" style="font-size:.98em"><b>Institution</b>: {{ $education->institution}}</div>
            <div class="text-lg" style="font-size:.98em"><b>Qualification Obtained</b>: {{ $education->qualification}}</div><div class="text-lg" style="font-size:.98em"><b>Field of Study</b>: {{$education->study_field}}</div>
            <div class="text-lg" style="font-size:.98em"><b>Start Date</b>: {{ $education->start_date}}</div><div class="text-lg" style="font-size:.98em"><b>End Date</b>: {{$education->end_date}}</div>
            <div class="text-lg" style="font-size:.98em"><b>Grade</b>: {{ $education->grade}}</div>
