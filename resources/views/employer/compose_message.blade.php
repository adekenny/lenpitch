  ...
  <div class="relative md:ml-64 bg-blueGray-50">
    ...
    <x-slot name="header">
        ...
        <span class="bg-indigo-700 py-1 px-2 rounded text-white text-sm"><a href="{{ url('employer_bookmark/'.$user->id) }}">Bookmark Profile</a></span>
            <span class="bg-green-500 py-1 px-2 rounded text-white text-sm"><a href="{{ url('employer/compose_message') }}">Message User</a></span>
            </div>
            </h2>
            </x-slot>
                        ...
                        <div class="w-full md:w-3/12 md:mx-2 shadow-lg rounded-lg">
                            ...
                            <div class="bg-white p-5 border-t-4 border-red-500">
                                ...
                                @if($user->titlecover)
                                    ...
                                    <br/> {{ $user->titlecover->description }}
                                    <br/><br/>
                                ...
                                <ul class="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                                    <li class="flex items-center py-3">
                                        <span>Status</span> @if($user->status == 'enabled')
                                    ...
                                    Disabled
                                        ...
                                        @endif @if($user->verification == 'verified')
                                        <span class="ml-auto"><span
                                    class="bg-blue-500 py-1 px-2 rounded text-white text-sm">                            
                                    verified
                                  </span> @elseif($user->verification == 'unverified')
                                        <span class="ml-auto"><span
                                    ...
                                    <div class="grid grid-cols-2">
                                        <div>
                                            ...
                                            <a href="#" style="text-decoration:underline">
                                                <h2 class="text-x font-bold">{{ $education->institution }}</h2>
                                            </a>
                                        ...
                                        <div>
                                            ...
                                            <a href="#" style="text-decoration:underline">
                                                <h2 class="text-x font-bold">{{ $work->title }}</h2>
                                            </a>
                ...
                <section class="max-w-4xl mx-auto bg-white rounded-md shadow-md dark:bg-gray-800 pt-1">
                    ...
                    <div id="modal_overlay" class="absolute inset-0 bg-black bg-opacity-80 h-screen w-full flex justify-center items-start md:items-center pt-10 md:pt-0">
                        ...
                        &cross;
                            ...
                            <h2 class="text-xl"><b>Send a short direct message to a jobseeker</b></h2>
                            <br/>
                            <div class="flex justify-self-auto">
                                <div class="pr-5">Firstname: {{ $user->firstname }}</div>
                                <div>Firstname: {{ $user->surname }}</div>
                            </div>
                    ...
                    <x-input id="title" class="block mt-1 w-full" type="text" name="title" required autofocus />
                                        ...
                                        <div class="w-full mt-4">
                                            ...
                                            <textarea class="block w-full h-20 px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600" name="description" required focus></textarea>
                                        </div>
                                        <div class="flex justify-between mt-6">

                                            <button name="save_add" class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Send</button>
                                        </div>
