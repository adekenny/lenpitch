                 ...
                 <thead>
                  ...
                  @php $x = 1; @endphp 
                    ...
                    @foreach($messages as $user)
                      ...
                      <td class="p-1 text-sm"> <a href="{{ url('employer_delete_message/'.$user->receiver_id) }}"><button class="px-4 py-1 hover:bg-blue-400 text-white rounded-full focus:border-4 border-indigo-300 bg-red-600 text-sm leading-3">delete</button></td>
	                  	</tr>
                      @php $x++; @endphp 
