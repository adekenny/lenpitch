...
<div id="modal" class="opacity-0 transform -translate-y-full scale-150  relative w-10/12 md:w-3/4 md:h-auto bg-white rounded shadow-lg transition-opacity transition-transform duration-300 p-6">
    ...
    <div class="px-4 py-3 h-auto">
        <h2 class="text-xl">Brief introduction of company or business activities</h2>
        <br/>
        <form  method="POST" action="{{ route('titlecover.store') }}">
        @csrf
            ...
            <div class="w-full mt-4">
                ...
                <textarea class="block w-full h-40 px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600" name="description" required focus ></textarea>
            </div>
