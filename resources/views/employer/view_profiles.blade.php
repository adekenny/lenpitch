                 ...
                 <thead>
                  ...
                  @php $x = 1; @endphp 
                    ...
                    @foreach($users as $user)
                      ...
                      <td class="p-1 text-sm"> <a href="{{ url('employer_view_user/'.$user->id) }}"><button class="px-4 py-1 hover:bg-blue-400 text-white rounded-full focus:border-4 border-indigo-300 bg-black text-sm leading-3">view profile</button></td>
	                  	</tr>
                      @php $x++; @endphp 
