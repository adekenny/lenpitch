    ...
    @if($bookmark)
                 ...
                 <thead>
		               <tr>
			                ...
			                <th class="bg-pink-700 text-white text-left pl-2">phone</th>
		                  <th class="bg-pink-700 text-white text-left pl-2">email</th>
                      <th class="bg-pink-700 text-white text-left pl-2">gender</th>
                      <th class="bg-pink-700 text-white text-left pl-2">category</th>
                  ...
                  @php $x = 1; @endphp 
                    ...
                    @foreach($bookmark as $user)
                      ...
                      <td class="p-1 text-sm"> <a href="{{ url('employer_view_user/'.$user->profile_id) }}"><button class="px-4 py-1 hover:bg-blue-400 text-white rounded-full focus:border-4 border-indigo-300 bg-black text-sm leading-3">view profile</button></td>
                      <td class="p-1 text-sm"> <a href="{{ url('employer_delete_bookmark/'.$user->profile_id) }}"><button class="px-4 py-1 hover:bg-blue-400 text-white rounded-full focus:border-4 border-indigo-300 bg-red-600 text-sm leading-3">delete</button></td>
	                  	</tr>
                      @php $x++; @endphp 
