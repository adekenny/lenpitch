...
<div id="modal" class="opacity-0 transform -translate-y-full scale-150  relative w-10/12 md:w-3/4 md:h-auto bg-white rounded shadow-lg transition-opacity transition-transform duration-300 p-6">
    ...
    <div class="px-4 py-3 border-b border-gray-200">
      <h2 class="py-4">Please watch this 60 seconds video first</h2>
   
      <video width="700" height="220" controls autoplay>
     
      <source src="{{ asset('lenspitch/public/storage/'.$video->video) }}" type="video/mp4">
...
setTimeout(myFunction, 60000), false);

function myFunction() {
 
  window.location = "http://lenspitch.com/employer/view_profiles";
}
