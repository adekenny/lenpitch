                ...
                <div class="bg-white p-5 border-t-4 border-red-500">
                     <div class="image overflow-hidden">
                        ...
                        <a href="{{ url('photo/create') }}"><img class="h-84 w-82 mx-auto"
                            src="{{ asset('upload.png') }}" width="230" height="230"
                            alt=""></a>
...
<div id="modal" class="opacity-0 transform -translate-y-full scale-150  relative w-10/12 md:w-3/4 md:h-auto bg-white rounded shadow-lg transition-opacity transition-transform duration-300 p-6">
    ...
    <div class="px-4 py-3 border-b border-gray-200 h-auto">
        <h2 class="text-2xl">Upload CV</h2>  
    </div>
    <div class="px-4 py-3 border-b border-gray-200 h-auto">
    <form method="POST" enctype="multipart/form-data" id="upload-profile-photo" action="{{route('cv.store') }}" >
        @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <input type="file" name="cv" placeholder="Choose document" id="cv">
                    @error('image')
