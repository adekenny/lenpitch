            ...
            <div class="w-full md:w-3/12 md:mx-2 shadow-lg rounded-lg">
                ...
                <div class="bg-white p-5 border-t-4 border-red-500">
                    ...
                    <p class="text-sm text-gray-500 hover:text-gray-500 leading-4">
                        ...
                        <a href="{{ route('titlecover.create') }}"><button class="py-3 px-3 my-4 transition-colors duration-700 transform bg-gray-500 hover:bg-blue-400 text-gray-100 rounded-lg focus:border-4 border-indigo-300 text-sm">Add Business Idea Overview</button></a>
                            ...
                            <div class="flex items-center space-x-2 font-semibold text-black leading-8 mb-3 bg-gray-100 rounded pl-2 py-2 mr-8">
                                ...
                                @else
                                    @foreach(Auth()->user()->documents as $document)
                                      ...
                                      <p class="text-sm font-bold py-2" style="text-decoration:underline; text-transform:UPPERCASE"><a href="{{ asset('lenspitch/public/storage/'.$document->document) }}" target="_blank">{{ $document->title }}</a></p>
                                     
                                      <form method="post" action="{{route('document.destroy',$document->id)}}">
                                      @method('delete')
                                      @csrf
                                        <button class="p-1 transition-colors duration-700 transform hover:bg-blue-400 text-gray-500 rounded focus:border-4 border-indigo-300 text-xs bg-gray-300" type="submit">Delete</button></form>
                        ...
                        <div> 
                            ...
                            @php
                                ...
                                @endphp 
                                      ...
                                      <p class="text-sm font-bold py-4"><a href="{{ asset('lenspitch/public/storage/'.Auth()->user()->video->video) }}" target="_blank">View Uploaded Video</a></p>
