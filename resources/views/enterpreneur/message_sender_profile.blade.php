                  ...
                  @php $x = 1; @endphp 
                    ...
                    @foreach($messages as $user)
		                  ...
		                  <tr class="bg-transparent text-blue-900">
                            ...
                            <td class="p-1 text-sm text-blue-800"><a href="{{ url('message_sender_profile/'.$user->user_id) }}">View Sender's Profile</a></td>
                      ...
                      <td class="p-1 text-sm"> <a href="{{ url('jobseeker_delete_message/'.$user->receiver_id) }}"><button class="px-4 py-1 hover:bg-blue-400 text-white rounded-full focus:border-4 border-indigo-300 bg-red-600 text-sm leading-3">delete message</button></td>
	                  	</tr>
                      @php $x++; @endphp 
...
<div id="modal" class="opacity-0 transform -translate-y-full scale-150  relative w-10/12 md:w-2/3 md:h-auto bg-white rounded shadow-lg transition-opacity transition-transform duration-300">
    ...
    <div class="grid grid-cols-2 gap-8 px-4 py-4">
            <div class="text-lg col-span-2" style="font-size:.98em"><b>Firstname:</b>: {{ $sender->firstname}}</div>
            <div class="text-lg col-span-2"  style="font-size:.98em"><b>Surname:</b>: {{ $sender->surname}}</div>
            <div class="text-lg col-span-2" style="font-size:.98em"><b>Email:</b>: {{ $sender->email}}</div>
            
            <div class="text-lg" style="font-size:.98em"><b>Category</b>: {{ $sender->category}}</div>
